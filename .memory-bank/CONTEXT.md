...
## Recent Changes
- 2026-07-04: Graduated from `~/.claude/hooks/improve-prompt.py` (1244L monolith) to `~/prompt-improve/` package
...
Shim at `~/.claude/hooks/improve-prompt.py` delegates to the package.
